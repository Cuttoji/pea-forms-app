        ...
        <View style={styles.section}>
         ...
         <View style={styles.section}>
            ...
            <View style={styles.gridContainer}>
                ...
                <View style={styles.gridColumn}>
                    ...
                    <View style={{...styles.subItem, flexDirection: 'column'}}>
                      ...
                      <View style={{...styles.row, paddingLeft: 5}}>
                          ...
                          <Field label="อื่นๆ" value={formData.cableType === 'อื่นๆ' ? (formData.cableOtherType || '') : ''} style={{width: '100%'}}/>
                          <Field label="ขนาด" value={`${formData.cableSizeSqmm || ''} ตร.มม.`} style={{width: '100%'}}/>
                      </View>
                    ...
                    {/* 2.2 */}
                    <Text style={{fontWeight: 'bold', marginTop: 8, marginBottom: 2}}>2.2 เครื่องป้องกันกระแสเกินฯ</Text>
                    ...
                    <View style={styles.checklistItem}><Text style={styles.itemText}>ข) สอดคล้องกับขนาดมิเตอร์ (AT {formData.breakerAmpRating || ''})</Text><Checkbox checked={formData.breakerMeterMatch_correct === 'ถูกต้อง'}/><Text> ถูกต้อง</Text><Checkbox checked={formData.breakerMeterMatch_correct === 'ต้องแก้ไข'}/><Text> ต้องแก้ไข: {formData.breakerMeterMatch_correct === 'ต้องแก้ไข' ? (formData.breakerMeterMatch_correct_note || ''):''}</Text></View>
                ...
                <View style={styles.gridColumn}>
                    {/* 2.3 */}
                    <Text style={{fontWeight: 'bold', marginBottom: 2}}>2.3 ระบบการต่อลงดินฯ</Text>
                    <View style={styles.checklistItem}><Text style={styles.itemText}>ก) ขนาดสายต่อหลักดิน ({formData.groundWireSizeSqmm || ''} ตร.มม.)</Text><Checkbox checked={formData.groundWireSize_correct === 'ถูกต้อง'}/><Text> ถูกต้อง</Text><Checkbox checked={formData.groundWireSize_correct === 'ต้องแก้ไข'}/><Text> ต้องแก้ไข: {formData.groundWireSize_correct === 'ต้องแก้ไข' ? (formData.groundWireSize_correct_note || ''):''}</Text></View>
                    <View style={styles.checklistItem}><Text style={styles.itemText}>ข) ความต้านทานดิน ({formData.groundResistanceOhm || ''} โอห์ม)</Text><Checkbox checked={formData.groundResistance_correct === 'ถูกต้อง'}/><Text> ถูกต้อง</Text><Checkbox checked={formData.groundResistance_correct === 'ต้องแก้ไข'}/><Text> ต้องแก้ไข: {formData.groundResistance_correct === 'ต้องแก้ไข' ? (formData.groundResistance_correct_note || ''):''}</Text></View>
                    ...
                    <View style={{...styles.row, paddingLeft: 10, marginTop: 2, flexDirection: 'column', alignItems: 'flex-start'}}>
