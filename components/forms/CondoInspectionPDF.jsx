    ...
    <Document>
        ...
        <View style={styles.section}>
            ...
            <View style={{...styles.subItem, flexDirection: 'column'}}>
              ...
              <View style={styles.row}>
                  ...
                  <Field label="อื่นๆ" value={formData.cableType === 'อื่นๆ' ? getFullText('cableOtherType') : ''} style={{width: '40%'}}/>
                  <Field label="ขนาด" value={`${getFullText('cableSizeSqmm')} ตร.มม.`} style={{width: '40%'}}/>
              </View>
              <View style={styles.checklistItem}><Checkbox checked={formData.cableTypeSize_correct === 'ถูกต้อง'}/><Text> ถูกต้อง</Text><Checkbox checked={formData.cableTypeSize_correct === 'ต้องแก้ไข'}/><Text> ต้องแก้ไข: {formData.cableTypeSize_correct === 'ต้องแก้ไข' ? getFullText('cableTypeSize_correct_note') : ''}</Text></View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
            ...
            <Text style={styles.acknowledgementText}>6.1 งานเดินสายและติดตั้งอุปกรณ์ไฟฟ้า... (คัดลอกข้อความเต็มจาก PDF)</Text>
            <Text style={styles.acknowledgementText}>6.2 ในกรณีที่การไฟฟ้าส่วนภูมิภาค... (คัดลอกข้อความเต็มจาก PDF)</Text>
            <Text style={styles.acknowledgementText}>6.3 สำหรับระบบไฟฟ้าของผู้ขอใช้ไฟฟ้า... (คัดลอกข้อความเต็มจาก PDF)</Text>
            <Text style={styles.acknowledgementText}>6.4 หากเกิดความเสียหายใดๆ... (คัดลอกข้อความเต็มจาก PDF)</Text>
        </View>
