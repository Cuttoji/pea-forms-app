...
export default function RootLayout({ children }: { children: React.ReactNode }) { // เพิ่ม type สำหรับ children
  return (
    <html lang="th" className={`${kanit.variable} ${inter.variable}`}>
      ...
      <body className="font-kanit bg-gradient-to-br from-purple-100 via-purple-50 to-indigo-100 text-gray-800 min-h-screen flex flex-col">
        <nav className="bg-gradient-to-r from-[#5b2d90] to-[#3a1a5b] text-white p-4 shadow-lg sticky top-0 z-50">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <div className="space-x-4">
              <Link href="/" legacyBehavior><a className="hover:text-purple-300 transition-colors">หน้าหลัก</a></Link>
              <Link href="/auth/register" legacyBehavior><a className="hover:text-purple-300 transition-colors">สมัครสมาชิก</a></Link>
        ...
        <footer className="bg-gray-800 text-white text-center text-sm p-6 mt-10">
          ...
          <div className="mt-2">
            <Link href="/privacy-policy" legacyBehavior><a className="hover:underline mx-2">นโยบายความเป็นส่วนตัว</a></Link>
            <Link href="/terms-of-service" legacyBehavior><a className="hover:underline mx-2">ข้อกำหนดการใช้งาน</a></Link>
          </div>
        </footer>
      </body>
    </html>
