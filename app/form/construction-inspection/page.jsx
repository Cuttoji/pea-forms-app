...
export default function PEAChecklistForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    hv_poleInstallation: "", // CorrectiveRadio
    hv_poleInstallation_note: "",
    hv_insulatorInstallation: "", // CorrectiveRadio
    hv_insulatorInstallation_note: "",
    hv_lightningRodInstallation: "", // CorrectiveRadio
    hv_lightningRodInstallation_note: "",
    hv_anchorInstallationDistribution: "", // CorrectiveRadio
    hv_anchorInstallationDistribution_note: "",
    hv_anchorInstallationLightning: "", // CorrectiveRadio
    hv_anchorInstallationLightning_note: "",
    hv_wireSagging: "", // CorrectiveRadio
    hv_wireSagging_note: "",
    hv_lightningRodSagging: "", // CorrectiveRadio
    hv_lightningRodSagging_note: "",
    hv_wireClearanceHeight: "", // CorrectiveRadio
    hv_wireClearanceHeight_note: "",
    hv_insulatorTying: "", // CorrectiveRadio
    hv_insulatorTying_note: "",
    hv_insulatedWireSplicing: "", // CorrectiveRadio
    hv_insulatedWireSplicing_note: "",
    hv_insulatedWireBranching: "", // CorrectiveRadio
    hv_insulatedWireBranching_note: "",
    hv_wireTermination: "", // CorrectiveRadio
    hv_wireTermination_note: "",
    hv_treeTrimming: "", // CorrectiveRadio
    hv_treeTrimming_note: "",
    hv_polePainting: "", // CorrectiveRadio
    hv_polePainting_note: "",
    hv_poleNumbering: "", // CorrectiveRadio
    hv_poleNumbering_note: "",
    hv_guying: "", // CorrectiveRadio
    hv_guying_note: "",
    hv_grounding: "", // CorrectiveRadio
    hv_grounding_note: "",
    hv_groundResistance: "", // Input for value
    hv_groundResistanceSystem: "", // Input for value
    hv_surgeArresterInstallation: "", // CorrectiveRadio
    hv_surgeArresterInstallation_note: "",
    hv_other: "", // CorrectiveRadio
    hv_other_note: "",

    // 2. ระบบจำหน่ายแรงต่ำ (Low Voltage Distribution System)
    lv_poleInstallation: "", // CorrectiveRadio
    lv_poleInstallation_note: "",
    lv_rackInstallationHorizontal: "", // CorrectiveRadio
    lv_rackInstallationHorizontal_note: "",
    lv_rackInstallationVertical: "", // CorrectiveRadio
    lv_rackInstallationVertical_note: "",
    lv_anchorInstallation: "", // CorrectiveRadio
    lv_anchorInstallation_note: "",
    lv_wireSagging: "", // CorrectiveRadio
    lv_wireSagging_note: "",
    lv_communicationWireClearance: "", // CorrectiveRadio
    lv_communicationWireClearance_note: "",
    lv_wireClearanceHeight: "", // CorrectiveRadio
    lv_wireClearanceHeight_note: "",
    lv_rollerTying: "", // CorrectiveRadio
    lv_rollerTying_note: "",
    lv_wireSplicingSingleEnd: "", // CorrectiveRadio
    lv_wireSplicingSingleEnd_note: "",
    lv_wireBranchingSingleEnd: "", // CorrectiveRadio
    lv_wireBranchingSingleEnd_note: "",
    lv_wireTerminationDoubleEnd: "", // CorrectiveRadio
    lv_wireTerminationDoubleEnd_note: "",
    lv_surgeArresterInstallation: "", // CorrectiveRadio
    lv_surgeArresterInstallation_note: "",
    lv_polePainting: "", // CorrectiveRadio
    lv_polePainting_note: "",
    lv_poleNumbering: "", // CorrectiveRadio
    lv_poleNumbering_note: "",
    lv_guying: "", // CorrectiveRadio
    lv_guying_note: "",
    lv_grounding: "", // CorrectiveRadio
    lv_grounding_note: "",
    lv_totalGroundResistance: "", // Input for value
    lv_other: "", // CorrectiveRadio
    lv_other_note: "",

    // 3. การติดตั้งหม้อแปลง (Transformer Installation)
    transformerType: "", // "แขวนเสา" or "นั่งร้าน"
    transformerKVA: "", // Input for KVA
    transformer_installation: "", // CorrectiveRadio
    transformer_installation_note: "",
    transformer_insulatorBondwire: "", // CorrectiveRadio
    transformer_insulatorBondwire_note: "",
    transformer_hvWireRoutingPhase: "", // CorrectiveRadio
    transformer_hvWireRoutingPhase_note: "",
    transformer_wireTyingInsulator: "", // CorrectiveRadio
    transformer_wireTyingInsulator_note: "",
    transformer_hvSurgeArrester: "", // CorrectiveRadio
    transformer_hvSurgeArrester_note: "",
    transformer_dropoutPinTerminalFuseLink: "", // CorrectiveRadio
    transformer_dropoutPinTerminalFuseLink_note: "",
    transformer_conspanInstallation: "", // CorrectiveRadio
    transformer_conspanInstallation_note: "",
    transformer_bushingTermination: "", // CorrectiveRadio
    transformer_bushingTermination_note: "",
    transformer_lvWireRoutingPhase: "", // CorrectiveRadio
    transformer_lvWireRoutingPhase_note: "",
    transformer_lvSurgeArrester: "", // CorrectiveRadio
    transformer_lvSurgeArrester_note: "",
    transformer_ltSwitchFuse: "", // CorrectiveRadio
    transformer_ltSwitchFuse_note: "",
    transformer_tankHandleHangerConduit: "", // CorrectiveRadio
    transformer_tankHandleHangerConduit_note: "",
    transformer_concreteBeamPoleBase: "", // CorrectiveRadio
    transformer_concreteBeamPoleBase_note: "",
    transformer_grounding: "", // CorrectiveRadio
    transformer_grounding_note: "",
    transformer_tankGrounding: "", // CorrectiveRadio
    transformer_tankGrounding_note: "",
    transformer_hvGrounding: "", // CorrectiveRadio
    transformer_hvGrounding_note: "",
    transformer_lvGrounding: "", // CorrectiveRadio
    transformer_lvGrounding_note: "",
    transformer_groundResistancePerPoint: "", // Input for value
    transformer_groundResistanceSystem: "", // Input for value
    transformer_other: "", // CorrectiveRadio
    transformer_other_note: "",

    // Inspection Summary
    inspectionResult: "", // "ถูกต้องตามมาตรฐาน กฟภ." or "เห็นควรแก้ไข"
    correctionDetails: "", // Textarea for correction details if "เห็นควรแก้ไข"
    correctedAndApproved: false, // Checkbox for "ได้แก้ไขให้ถูกต้องตามมาตรฐานทุกรายการแล้ว"
  ...
  // Handle changes for all input fields (text, number, select, radio, checkbox)
  const handleChange = (e) => {
    const { name, value, type, checked } = e.target;

    setFormData((prev) => ({
      ...prev,
      [name]: type === "checkbox" ? checked : value, // Set 'checked' for checkboxes, 'value' for others
    }));
  };

  // Handle changes specifically for CorrectiveRadio component status
  const handleRadioChange = (groupName, value, noteFieldName) => {
    setFormData((prev) => ({
      ...prev,
      [groupName]: value, // Update the status (e.g., 'ถูกต้อง' or 'ต้องแก้ไข')
      ...(value === 'ถูกต้อง' && { [noteFieldName]: '' }), // Clear the note if status is set to 'ถูกต้อง'
    }));
  };

  // useEffect to set initial date to current date when component mounts
  useEffect(() => {
    const today = new Date();
    const year = today.getFullYear();
    const month = String(today.getMonth() + 1).padStart(2, '0'); // Month is 0-indexed, so add 1
    const day = String(today.getDate()).padStart(2, '0');
    const formattedDate = `${year}-${month}-${day}`; // YYYY-MM-DD format for date input type

    setFormData(prev => ({
      ...prev,
      inspectionDate: formattedDate,
      // You might want to set other date fields similarly if they should default to today
    }));
  }, []); // Empty dependency array means this code runs only once on mount

  // Handle form submission
  const handleSubmit = (e) => {
    e.preventDefault(); // Prevent default form submission behavior
    console.log("Form Data Submitted:", formData); // Log current form data to console
    // TODO: Integrate with backend for form submission (e.g., API call)
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-white rounded-lg shadow-md max-w-4xl mx-auto my-8">
      ...
      {/* REMOVED THE NESTED <form> TAG HERE */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="hvWorkVolumeKm" name="hvWorkVolumeKm" value={formData.hvWorkVolumeKm} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="hvWorkVolumePoles" className="block text-sm font-medium text-gray-700 mb-1">
                จำนวนเสา (ต้น):
              </label>
              <input type="text" id="hvWorkVolumePoles" name="hvWorkVolumePoles" value={formData.hvWorkVolumePoles} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="hvStation" className="block text-sm font-medium text-gray-700 mb-1">
                รับไฟจากสถานี:
              </label>
              <input type="text" id="hvStation" name="hvStation" value={formData.hvStation} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="hvFeeder" className="block text-sm font-medium text-gray-700 mb-1">
                ฟีดเดอร์:
              </label>
              <input type="text" id="hvFeeder" name="hvFeeder" value={formData.hvFeeder} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="hvPhase" className="block text-sm font-medium text-gray-700 mb-1">
                เฟสที่ต่อ:
              </label>
              <input type="text" id="hvPhase" name="hvPhase" value={formData.hvPhase} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="hvTransformerKVA" className="block text-sm font-medium text-gray-700 mb-1">
                หม้อแปลงรวม (KVA):
              </label>
              <input type="text" id="hvTransformerKVA" name="hvTransformerKVA" value={formData.hvTransformerKVA} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
          </div>
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="lvWorkVolumeKm" name="lvWorkVolumeKm" value={formData.lvWorkVolumeKm} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="lvWorkVolumePoles" className="block text-sm font-medium text-gray-700 mb-1">
                จำนวนเสา (ต้น):
              </label>
              <input type="text" id="lvWorkVolumePoles" name="lvWorkVolumePoles" value={formData.lvWorkVolumePoles} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
          </div>
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="supervisorName" name="supervisorName" value={formData.supervisorName} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="supervisorPosition" className="block text-sm font-medium text-gray-700 mb-1">
                ตำแหน่ง:
              </label>
              <input type="text" id="supervisorPosition" name="supervisorPosition" value={formData.supervisorPosition} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="supervisorAffiliation" className="block text-sm font-medium text-gray-700 mb-1">
                สังกัด:
              </label>
              <input type="text" id="supervisorAffiliation" name="supervisorAffiliation" value={formData.supervisorAffiliation} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
            </div>
            <div>
        ...
        <div className="space-y-4">
          ...
          <div className="border-b border-gray-200 pb-4 mb-4">
            ...
            <CorrectiveRadio
              ...
              currentNote={formData.lv_grounding_note} // Corrected note field name
              onStatusChange={handleRadioChange}
              onNoteChange={handleChange}
            />
          </div>
      ...
      <section className="bg-gray-50 p-6 rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input type="text" id="inspector1Name" name="inspector1Name" value={formData.inspector1Name} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
          <div>
            <label htmlFor="inspector1Position" className="block text-sm font-medium text-gray-700 mb-1">
              ตำแหน่ง:
            </label>
            <input type="text" id="inspector1Position" name="inspector1Position" value={formData.inspector1Position} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
          <div>
            <label htmlFor="inspector1Date" className="block text-sm font-medium text-gray-700 mb-1">
              ลงวันที่:
            </label>
            <input type="date" id="inspector1Date" name="inspector1Date" value={formData.inspector1Date} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" id="supervisorSignatureName" name="supervisorSignatureName" value={formData.supervisorSignatureName} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
          <div>
            <label htmlFor="supervisorSignaturePosition" className="block text-sm font-medium text-gray-700 mb-1">
              ตำแหน่ง:
            </label>
            <input type="text" id="supervisorSignaturePosition" name="supervisorSignaturePosition" value={formData.supervisorSignaturePosition} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
          <div>
            <label htmlFor="supervisorSignatureDate" className="block text-sm font-medium text-gray-700 mb-1">
              ลงวันที่:
            </label>
            <input type="date" id="supervisorSignatureDate" name="supervisorSignatureDate" value={formData.supervisorSignatureDate} onChange={handleChange} className="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm focus:border-[#a78bfa] focus:ring-[#a78bfa]" />
          </div>
        </div>
      </section>
