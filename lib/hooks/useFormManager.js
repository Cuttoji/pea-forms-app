...
export const useFormManager = (
  ...
  const transformFormData = useCallback((data, userId, isUpdate, numericFields) => {
    ...
    // Transform numeric fields - convert empty strings to null
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      // ส่ง numericFields เข้าไปใน transformFormData
      const dataToSubmit = transformFormData(formData, user.id, !!id, numericFields);
