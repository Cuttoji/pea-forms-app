const constructionFormSchema = {
    ...
    sections: [
  {
    ...
    items: [
      ...
      { key: "hv_1_17_1", label: "- ค่าความต้านทานดินต่อจุด............(โอห์ม), ระยะ.......โอห์ม", ohm: "", system: "", result: "", detail: "", note: "" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "lv_2_2", label: "2.2 การติดตั้งคอน แร็ค ชายตัวถอนฝักชาย", result: "", detail: "", note: "" },
      ...
      { key: "lv_2_15", label: "2.15 ค่าความต้านทานดินรวม............(โอห์ม)", ohm: "", result: "", detail: "", note: "" },
  ...
  },
  {
    ...
    items: [
      { key: "tr_3_0", label: "TR ............Ø ............. kVA", number: "", phase: "", kva: "", type: [], result: "", detail: "", note: "" },
      ...
      { key: "tr_3_15", label: "3.15 ค่าความต้านทานดินต่อจุด............(โอห์ม), ระยะ.......โอห์ม", ohm: "", system: "", result: "", detail: "", note: "" },
